...
class user:
    ...
    def eventStatistics(self):
        ...
        global db
        info = {}
        sql1 = "select count(*) from event_info"
        cursor.execute(sql1)
    ...
    def eventStatistics1(self):
        ...
        cursor.execute(sql1)
        result1 = cursor.fetchall()
        sql = "select * from event_info where event_type = 0"
        sql2 = "select * from event_info where event_type = 1"
        sql3 = "select * from event_info where event_type = 2"
        sql4 = "select * from event_info where event_type = 3"
        sql5 = "select * from event_info where event_type = 4"
        sql6 = "select * from event_info "
        cursor.execute(sql)
        result = cursor.fetchall()
        cursor.execute(sql2)
