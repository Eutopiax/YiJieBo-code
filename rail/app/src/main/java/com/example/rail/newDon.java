...
import com.example.rail.ui.TabTopAutoLayout;
import com.example.rail.util.ActivityCollector;

import java.util.ArrayList;

public class newDon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.newdon);
        bt = findViewById(R.id.back);
        bt.setOnClickListener(new View.OnClickListener(){  //点击按钮监听
            @Override
            public void onClick(View v){
                Intent i = new Intent(newDon.this, MainActivity.class); //切换窗口
                startActivity(i);
            }
        });
        //初始化控件
    ...
    public void ShowFragment(int checkedIndex) {
        ...
        hideFragments();
        //=============To Do根据实际情况显示不同的区域=============
        if(tabTitleList.get(checkedIndex).toString()=="捐赠")
            setContentView(R.layout.newdon);
